...
export const themes: Record<AppThemeName, AppThemeConfig> = {
  default: {
    ...
    colors: {
      ...
      navbarText: { light: 'rgba(255, 255, 255, 0.85)', dark: 'rgba(255, 255, 255, 0.85)' },
      navbarTextDimmed: { light: 'rgba(255, 255, 255, 0.55)', dark: 'rgba(255, 255, 255, 0.55)' },
  ...
  kaizen: {
    ...
    colors: {
      ...
      navbarTextDimmed: { light: '#64748b', dark: '#64748b' },
