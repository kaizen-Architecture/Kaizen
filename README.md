...
| 📋 **Backlog** | **Clickable Dashboard Activity Links** | *(Planned - Dashboard > Recent Activity)* | Make recent downloaded activity feed items clickable links navigating directly to `/manga/[id]`. |
